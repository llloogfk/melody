...
introduce1 = play.new_text(words = 'Фортепиано для удовольствия!', x = 0, y = 200)
introduce2 = play.new_text(words = 'Создайте свою мелодию, нажимая на клавиши', x = 0, y = 150 )
...
kpm = play.new_text(words='играть', x=100, y=-170, font_size=20)

key_clear_melody = play.new_box(color='light yellow', border_color='black', border_width=1, x=100, y=-170, width=160, height=50)

kcm = play.new_text(words='удалить', x=100, y=-170, font_size=20)
...
# key1 = play.new_box(color='white', border_color='black', border_width=3, x = -140, y = 0, width = 40, height=100)
